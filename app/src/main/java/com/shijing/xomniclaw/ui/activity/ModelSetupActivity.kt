    ...
    companion object {
        ...
        private val PROVIDERS = mapOf(
            "openrouter" to ProviderPreset(
                ...
                models = listOf(
                    ModelPreset("z-ai/glm-4.5-air:free", "GLM-4.5 Air (免费，推荐)", reasoning = true, contextWindow = 262144, maxTokens = 16384),
                    ModelPreset("deepseek/deepseek-chat-v3-mini:free", "DeepSeek Chat v3 Mini (免费)", contextWindow = 131072, maxTokens = 8192),
                    ModelPreset("qwen/qwen2.5-7b-instruct:free", "Qwen 2.5 7B (免费)", reasoning = true, contextWindow = 200000, maxTokens = 16384),
                    ModelPreset("mistralai/mistral-nemo:free", "Mistral Nemo (免费)", contextWindow = 200000, maxTokens = 16384),
                    ModelPreset("anthropic/claude-3.5-haiku:free", "Claude 3.5 Haiku (免费)", reasoning = true, contextWindow = 1048576, maxTokens = 32768),
                ),
                authHeader = true
            ),
